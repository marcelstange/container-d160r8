...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-d160r8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-d160r8.containers.anotherwebservice.com/
...
```
git clone git@github.com:marcelstange/container-d160r8.git
cd container-d160r8
```
...
```
docker attach container-d160r8
```
